...
/*
	Rendering follower part, including avatar, name, headline
*/
export const Follower = ({ followers, adFollower, rmFollower, errorMessage, successMs}) => {
	...
	const _addFollower = () => {
		if (_follower.value != "") {
			adFollower(_follower.value, followers);
		}
	}
...
export default connect(
  ...
  (dispatch) => ({adFollower : (name, follow) => dispatch(addFollower(name, follow)),
