...
export const apiUrl = 'http://backend-hw7-hy23.herokuapp.com'
...
export function filterArticle(article, keyword, followers) {
  if (keyword.length == 0) {
...
/*
	To integrate the articles fetched from followers
*/
